        ...
        for i in op.multi_hand_landmarks:
            ...
            if curr_tool == "draw":
                ...
                if index_raised(yi, y9):
                    cv2.line(mask, (prevx, prevy), (x, y), col, thick)
                    prevx, prevy = x, y
                ...
                if index_raised(yi, y9):
                    ...
                    if var_inits:
                        # cv2.line(mask, (xii, yii), (x, y), draw_color, thick)
                        cv2.line(mask, (xii, yii), (x, y),
                                 color=draw_color, thickness=3)
                        var_inits = False
                ...
                if index_raised(yi, y9):
                    ...
                    if var_inits:
                        cv2.rectangle(mask, (xii, yii), (x, y), col, thick)
                        var_inits = False
